...
document.addEventListener("DOMContentLoaded", function () {
    ...
    tableroHTML.style.display = "none";
    let filas = 0
    let columnas = 0
    let lado = 30
    let marcas = 0
    ...
    const btn = document.getElementById("confjuego")
    btn.addEventListener("click", function () {
        filas = document.getElementById("nfilas").value
        columnas = document.getElementById("ncol").value
        ...
        switch (dificultad) {
            case 1:                
                ...
                break;
            case 2:
                minas = filas * columnas * 0.2
                break;
            case 3:
                minas = filas * columnas * 0.3
                break;
            case 4:
                minas = filas * columnas * 0.45
                break;
        }
    ...
    function nuevoJuego() {
        ...
        tableroHTML.style.display = "block";
        reiniciarVariables()
        ...
        anadirEventos() //se añaden los eventos de mouse para las celdas
    ...
    function verificarPerdedor() {
        ...
        for (let f = 0; f < filas; f++) {
            for (let c = 0; c < columnas; c++) {
                if (tablero[c][f].valor == -1) {
                    let celda = document.getElementById(`celda-${c}-${f}`)
                    celda.innerHTML = `<i class="fas fa-skull"></i>`
                    celda.style.color = "black"
                }
            }
        }
